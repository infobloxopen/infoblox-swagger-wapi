...
curl_setopt_array($curl, array(
  ...
  CURLOPT_HTTPHEADER => array(
    ...
    "Cookie: ibapauth=\"ip=10.195.28.158,client=API,group=admin-group,ctime=1589444185,timeout=60000,mtime=1589444185,su=1,auth=LOCAL,user=admin,QJlKO+zlahzk7vyuRh25IbV4yzz36s480d8\""
  ),
));
...
?>
<fieldset>
<h2>This IP-address/FQDN does not correspond to a grid master!!</h2>
